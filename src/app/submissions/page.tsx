  ...
  return (
    <>
      ...
      <main className="bg-black text-white overflow-hidden">
        ...
        {/* ── HERO ─────────────────────────────────────────────────────── */}
        <section className="relative min-h-[70vh] flex flex-col justify-end px-6 pt-40 pb-16 md:px-14 lg:px-20">
          {/* Red left bar */}
          <div className="absolute left-0 top-0 h-full w-1 bg-red" />

          {/* Ghost background text */}
          <p
            className="pointer-events-none absolute right-[-2vw] top-1/2 -translate-y-1/2 select-none font-poppins font-black uppercase leading-none text-white/[0.03]"
            style={{ fontSize: "22vw" }}
            aria-hidden
          >
            CREATE
                ...
                {status === "sent" ? (
                  ...
                  <form onSubmit={submit} className="relative flex flex-col gap-7">
                    ...
                    <Field label="Instagram Handle">
                      <input
                        name="instagram" value={form.instagram} onChange={update}
                    ...
                    <Field label="Category *">
                      <select
                        required name="category" value={form.category} onChange={update}
                    ...
                    <Field label="Subject / Title *">
                      <input
                        required name="subject" value={form.subject} onChange={update}
                        className={inputCls} placeholder="What are you submitting?"
                      />
                    </Field>

                    <Field label="Pitch / Message *">
                      <textarea
                        required name="message" value={form.message} onChange={update} rows={5}
                        className={inputCls + " resize-none"}
                        placeholder="Tell us about your work, your vision, and why it belongs in OBARE."
                      />
                    </Field>
                    ...
                    <button
                      ...
                      className="group relative self-start overflow-hidden rounded-full bg-red px-10 py-4 font-montserrat text-xs font-bold uppercase tracking-[0.25em] text-white transition-all hover:opacity-90 disabled:opacity-50"
                    >
